...
def run(env, agent, actor_optim, critic_optim, tb):
    ...
    for global_step in itertools.count():
        ...
        # actor_info_b == actor_info_b
        # eigen = torch.linalg.eigh(list(agent.actor.parameters())[0]).eigenvalues
        ...
        scalars_to_tb(tb, {**actor_info, **critic_info, "duration": len(trajectory)},
                      n_samples)
